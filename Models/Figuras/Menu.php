...
<head>
 ...
 <br><br>
  ...
  width: 150px; margin:240px 10px;   /* Ancho del botón */"class="boton" ></a>
    <a href="../menu.php" style=" background: url(Imagenes/Menu/btnSalir.png) /* Url de la imagen */ no-repeat center center, #62BC0F /* Color del botón */; background-size: 105%; height: 150px;  /* Alto del botón */
  width: 150px; margin:240px 10px; /* Ancho del botón */"class="boton"></a> 
